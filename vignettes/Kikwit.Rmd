...
simulated = epidemic.simulations(result1, replicates = 25)

allSimulatedI_star = sapply(simulated$simulationResults, function(x){x$I_star})
...
simulated = epidemic.simulations(result2, replicates = 25)
