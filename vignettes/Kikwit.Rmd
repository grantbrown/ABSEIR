...
simulated1 = epidemic.simulations(result1, replicates = 50)
...
simulated2 = epidemic.simulations(result2, replicates = 50)
...
```{r}
# Simulate new epidemics based on the accepted parameters for model 3
simulated3 = epidemic.simulations(result3, replicates = 50)
allSimulatedI_star = sapply(simulated3$simulationResults, function(x){x$I_star})
...
plot(Kikwit1995$Count, ylim = c(0, max(Kikwit1995$Count)*1.2),
     xlab = "Epidemic Day", ylab = "New Cases", main = "Model 3: Posterior Predictive Distribution")
lines(upperQuantile, lty = 2, col = "blue")
lines(lowerQuantile, lty = 2, col = "blue")
lines(posteriorMean, lty = 1, col = "blue")
...
```{r}
# Simulate new epidemics based on the accepted parameters for model 4
simulated4 = epidemic.simulations(result4, replicates = 50)
allSimulatedI_star = sapply(simulated4$simulationResults, function(x){x$I_star})
...
plot(Kikwit1995$Count, ylim = c(0, max(Kikwit1995$Count)*1.2),
     xlab = "Epidemic Day", ylab = "New Cases", main = "Model 4: Posterior Predictive Distribution")
lines(upperQuantile, lty = 2, col = "blue")
lines(lowerQuantile, lty = 2, col = "blue")
lines(posteriorMean, lty = 1, col = "blue")
...
allSimulatedR0_3 = sapply(simulated3$simulationResults, function(x){x$R0t})
allSimulatedEA_R0_3 = sapply(simulated3$simulationResults, function(x){x$R_EA})

allSimulatedR0_4 = sapply(simulated4$simulationResults, function(x){x$R0t})
allSimulatedEA_R0_4 = sapply(simulated4$simulationResults, function(x){x$R_EA})


par(mfrow = c(4,1))
plot(apply(allSimulatedR0_1, 1, mean), type = "l", ylim = c(0, 3), lwd =2,
     ylab = "Reproductive Number", main = "Model 1: R0(t) and EA-R(t)")
lines(apply(allSimulatedEA_R0_1, 1, mean), lwd = 2, lty = 2, col = "blue")

plot(apply(allSimulatedR0_2, 1, mean), type = "l", ylim = c(0, 3), lwd = 2,
     ylab = "Reproductive Number", main = "Model 2: R0(t) and EA-R(t)")
lines(apply(allSimulatedEA_R0_2, 1, mean), lwd =2, lty = 2, col = "blue")
legend(x = 130, y = 1.25, lty = c(1,2), col = c(1,4), legend = c("R0(t)", "EA-R(t)"),
       lwd = c(2,2), cex = 1.25)

plot(apply(allSimulatedR0_3, 1, mean), type = "l", ylim = c(0, 3), lwd = 2,
     ylab = "Reproductive Number", main = "Model 3: R0(t) and EA-R(t)")
lines(apply(allSimulatedEA_R0_3, 1, mean), lwd =2, lty = 2, col = "blue")
legend(x = 130, y = 1.25, lty = c(1,2), col = c(1,4), legend = c("R0(t)", "EA-R(t)"),
       lwd = c(2,2), cex = 1.25)
  
plot(apply(allSimulatedR0_4, 1, mean), type = "l", ylim = c(0, 3), lwd = 2,
     ylab = "Reproductive Number", main = "Model 4: R0(t) and EA-R(t)")
lines(apply(allSimulatedEA_R0_4, 1, mean), lwd =2, lty = 2, col = "blue")
legend(x = 130, y = 1.25, lty = c(1,2), col = c(1,4), legend = c("R0(t)", "EA-R(t)"),
       lwd = c(2,2), cex = 1.25)
