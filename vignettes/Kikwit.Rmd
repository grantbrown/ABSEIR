...
Finally, we can combine these components and fit the models. In an interactive session,
...
Models can be compared using Bayes Factors, and by producing posterior predictive plots. We'll take a look at both techniques.
