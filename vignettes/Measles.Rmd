...
weser.sampling_control <- SamplingControl(seed=123123,
                                               n_cores = 14,
...
makePlots <- function(modelObj, nm){
  ...
  Islb <- apply(Is, 1:2, quantile, probs = c(0.005))
  Isub <- apply(Is, 1:2, quantile, probs = c(0.995))
